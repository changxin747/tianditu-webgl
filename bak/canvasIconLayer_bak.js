function layerFactory(L) {
    ...
    var CanvasIconLayer = (L.LayerGroup ? L.LayerGroup : L.Class).extend({
        ...
        _reset: function () {
            ...
            var topLeft = this._map.containerPointToLngLat([0, 0]);
    ...
    L.DomUtil = {
        ...
        splitWords:function(str) {
            var strTrim =  str.trim ? str.trim() : str.replace(/^\s+|\s+$/g, '');
            return strTrim.split(/\s+/);
        },
        ...
        setTransform:function (el, offset, scale) {
            ...
            var TRANSFORM = this.testProp(['transform', 'webkitTransform', 'OTransform', 'MozTransform', 'msTransform']);
            el.style[TRANSFORM] =
                (1==1 ?
    ...
    L.Util = {
        ...
        stamp:function (obj) {
            /*eslint-disable */
            obj._leaflet_id = obj._leaflet_id || ++this.lastId;
