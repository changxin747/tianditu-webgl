function layerFactory(L) {
    ...
    var CanvasIconLayer = (L.LayerGroup ? L.LayerGroup : L.Class).extend({
        ...
        addMarkers: function (markers) {
            ...
            markers.forEach(function (marker) {
                ...
                if (!((marker.options.hE == 'markerPane') && marker.options.icon))
                {
        ...
        _addMarker: function(marker,latlng,isDisplaying) {
            ...
            var pointPos = self._map.lngLatToContainerPoint(latlng);
            var iconSize = marker.options.icon.options.iconSize;

            var adj_x = iconSize.x/2;
            var adj_y = iconSize.y/2;
            var ret = [({
        ...
        _drawImage: function (marker, pointPos) {
            ...
            this._context.drawImage(
                marker.canvas_img,
                pointPos.x - options.iconAnchor.x,
                pointPos.y - options.iconAnchor.y,
                options.iconSize.x,
                options.iconSize.y
            );
        },
        ...
        _reset: function () {
            ...
            var tlLngLat = this._map.containerPointToLngLat([0, 0]);
            var topLeft = this._map.lngLatToLayerPoint(tlLngLat);
        ...
        _redraw: function (clear) {
            ...
            self._latlngMarkers.search(mapBoxCoords).forEach(function (e) {
                ...
                //Readjust Point Map
                var pointPos = self._map.lngLatToContainerPoint(e.data.getLngLat());
        ...
        _initCanvas: function () {
            ...
            this._canvas = L.DomUtil.create('canvas', 'leaflet-canvas-icon-layer tdt-layer');
        ...
        _executeListeners: function (event) {
            ...
            if (ret && ret.length > 0) {
                ...
                me._map.getContainer().style.cursor="pointer";
                ...
                if (event.type==="mousemove") {
                    var hasTooltip = ret[0].data.getLabel();
                    if(hasTooltip) {
                ...
                me._map.getContainer().style.cursor="";
            }
        }
    });
